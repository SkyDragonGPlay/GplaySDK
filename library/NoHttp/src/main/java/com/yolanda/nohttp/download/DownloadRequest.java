...
public interface DownloadRequest extends IBasicRequest {
     ...
     */
    void onPreResponse(String what, DownloadListener downloadListener);

    /**
     * The callback mark.
     *
     * @return Return when {@link #onPreResponse(String, DownloadListener)} incoming credit.
     * @see #onPreResponse(String, DownloadListener)
     */
    String what();
