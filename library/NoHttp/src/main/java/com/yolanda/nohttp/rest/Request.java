...
public interface Request<T> extends IParserRequest<T> {
     ...
     */
    void onPreResponse(String what, OnResponseListener<T> responseListener);

    /**
     * The callback mark.
     *
     * @return Return when {@link #onPreResponse(String, OnResponseListener)} incoming credit.
     * @see #onPreResponse(String, OnResponseListener)
     */
    String what();
