...
public interface DownloadListener {
     ...
     */
    void onDownloadError(String what, Exception exception);
     ...
     */
    void onStart(String what, boolean isResume, long rangeSize, Headers responseHeaders, long allCount);
     ...
     */
    void onProgress(String what, int fileCount, int fileSize);
     ...
     */
    void onFinish(String what, String filePath);
