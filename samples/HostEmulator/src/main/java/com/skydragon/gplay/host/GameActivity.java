package com.skydragon.gplay.host;
...
import com.skydragon.gplay.host.ui.ProgressView;
import com.skydragon.gplay.host.ui.TipsManager;
import com.skydragon.gplay.host.utils.FileConstants;
import com.skydragon.gplay.host.utils.FileUtils;
import com.skydragon.gplay.host.utils.ThreadUtils;
import com.skydragon.gplay.host.utils.Utils;
import com.skydragon.gplay.host.utils.ZipUtils;
...
public class GameActivity extends Activity implements OnPrepareRuntimeListener, IGplayServiceProxy {
    ...
    private static String DIFFPATCH_PATH;
    ...
    private void initResDir() {
        ...
        DIFFPATCH_PATH = getSystemDataDir() + "diffpatch/" + "libdiffpatch.so";
        ...
        Utils.ensureFileExist(pathHostRuntimeEngineVersionDir);
        Utils.ensureFileExist(getSystemDataDir() + "diffpatch/");
        LIB_UNITY_JAR_PATH = pathHostRuntimeEngineVersionDir + RUNTIME_FILE_JAR_NAME;
            ...
            public void run() {
                ...
                ZipUtils.unpackZip(UNITY_RES_DIR + UNITY_ZIP, UNITY_RES_DIR, new ZipUtils.OnUnzipListener() {
                    ...
                    public void onUnzipSucceed(List<String> unzipFiles) {
                        ...
                        FileUtils.copyFile(UNITY_RES_DIR + "script/", mCacheDir + "/resource");
                        ...
                        FileUtils.copyFile(soResPath, DIFFPATCH_PATH);
                        Log.v(TAG, "Rooho# DIFFPATCH_PATH   " + DIFFPATCH_PATH + " exist ：" + new File(DIFFPATCH_PATH).exists());
    ...
    private void sendToDesktop() {
        ...
        Utils.downloadFileInThread(iconUrl, savePath, new com.skydragon.gplay.host.utils.OnFileDownloadListener() {
            @Override
