package com.skydragon.gplay.channel.plugin;
...
public class GplayChannelPaySDKPlugin implements IChannelSDKServicePlugin {
    ...
    public String invokeSyncExtraMethods(String method, JSONObject jsonParams) {
        Log.w(TAG,"invokeSyncExtraMethods:" + method + "  params:" + jsonParams);
        switch (method) {
            case "getUid": {
